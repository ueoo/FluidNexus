...
def add_sdedit_config_args(parser):
    ...
    group.add_argument("--sdedit-strength-fake", type=float, default=1.0)
    ...
    group.add_argument("--sdedit-frames-dir-fake", type=str, default=None)
    ...
    group.add_argument("--sdedit-prefix-start-idx-fake", type=int, default=81)
