...
python entries_fluid_nexus/train_physical_particle.py \
    ...
    --config configs/fluid_nexus_ball_future.json \
    --bg_load_path /path/to/FluidNexusRoot/fluid_nexus_dynamics_logs/fluid_nexus_ball_background \
    --model_path /path/to/FluidNexusRoot/fluid_nexus_dynamics_logs/fluid_nexus_ball_physical_reconstruction_future
