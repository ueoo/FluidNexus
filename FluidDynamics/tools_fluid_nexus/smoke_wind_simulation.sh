...
python entries_fluid_nexus/future_simulation.py \
    ...
    --config configs/fluid_nexus_smoke_dynamics_wind_simulation.json \
    ...
    --model_path /path/to/FluidNexusRoot/fluid_nexus_dynamics_logs/fluid_nexus_smoke_physical_wind_simulation
