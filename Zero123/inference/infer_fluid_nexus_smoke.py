...
def main_demo(project_root="/path/to/FluidNexusRoot", tgt_cam=0, cuda_idx=0, finetune_step=52000):
    src_cam = 2
    ...
    ckpt_dir = "2024-10-30T06-31-08_fluid_nexus_smoke"
    config = "configs/fluid_nexus_smoke.yaml"
