...
class FluidNexusStaticDataModuleFromConfig(pl.LightningDataModule):
    def __init__(
        self,
        root_dir,
        batch_size,
...
class FluidNexusStaticData(Dataset):
    def __init__(
        self,
        root_dir,
        image_transforms=[],
        ...
        # print(f"camera2_root_dir: {self.camera2_root_dir}")
        print(f"===========================================")
        ...
        # with open(self.seq_to_cam_path) as f:
        #     self.seq_to_cam = json.load(f)
    ...
    def __getitem__(self, index):
        ...
        cur_seq_frame = self.paths[index]
        filename = os.path.join(self.root_dir, cur_seq_frame)
